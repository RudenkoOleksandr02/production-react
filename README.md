...
2. [Доступні команди](#доступні-команди)
3. [Архітектура проєкту](#архітектура-проєкту)
4. [Shared layer](#shared-layer)
5. [Лінтинг і якість коду](#лінтинг-і-якість-коду)
6. [Тестування](#тестування)
7. [Storybook](#storybook)
8. [Інтернаціоналізація](#інтернаціоналізація)
9. [Рівень даних](#рівень-даних)
10. [Фічефлаги](#фічефлаги)
11. [Робота з фічефлагами](#робота-з-фічефлагами)
12. [Сутності і фічі](#сутності-і-фічі)
13. [Файли конфігурації](#файли-конфігурації)
14. [CI-пайплайн і прекомміт-хуки](#ci-пайплайн-і-прекомміт-хуки)
15. [Обробка даних](#обробка-даних)
...
* **Хуки** (`shared/lib/hooks`, `shared/lib/router`):
  ...
  * `useHover` — возвращает состояние наведения и бинды для onMouseEnter / onMouseLeave.
